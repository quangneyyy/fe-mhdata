...
(function () {
  var options = {
    ...
    xaxis: {
      type: 'category',
      categories: ["April 12", "April 19", "April 26", "May 02", "May 09", "May 16"],
      axisBorder: {
        show: false
      },
      axisTicks: {
...
(function () {
  var options = {
    series: [{
      name: 'Views',
      data: [3899, 1674, 983, 543, 216, 167]
    }],
    chart: {
      type: 'bar',
      height: '100%',
    ...
    xaxis: {
      categories: ['Ho Chi Minh city', 'Hanoi', 'Da Nang city', 'Binh Dinh', 'Can Tho', 'Nha Trang'],
      axisBorder: {
        show: false
      },
      axisTicks: {
